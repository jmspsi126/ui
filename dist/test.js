...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    _createClass(Button, [{
	        ...
	        value: function render() {
	            ...
	            if (this.props.iconLeft) {
	                iconLeft = _react2.default.createElement(_icon2.default, { className: 'ui-icon left', name: this.props.iconLeft });
	            }

	            var iconMiddle = null;
	            if (this.props.iconMiddle || this.props.icon) {
	                iconMiddle = _react2.default.createElement(_icon2.default, { className: 'ui-icon center', name: this.props.iconMiddle || this.props.icon });
	            }

	            var iconRight = null;
	            if (this.props.iconRight) {
	                iconRight = _react2.default.createElement(_icon2.default, { className: 'ui-icon right', name: this.props.iconRight });
	            }
	            ...
	            if (this.props.isLoading == true) {
	                isDisabled = true;
	                label = _react2.default.createElement('span', { style: { position: 'relative' } }, _react2.default.createElement('span', { style: { visibility: 'hidden' } }, label), _react2.default.createElement('div', { className: 'loading-icon' }));
	            }

	            var content = null;
	            if (this.props.children) {
	                content = _react2.default.createElement('span', { className: _styles2.default.label }, this.props.children);
	            } else {
	                content = _react2.default.createElement('span', { className: _styles2.default.label }, iconMiddle, label);
	            }

	            return _react2.default.createElement(this.container, _extends({}, this.props, {
	                href: isDisabled ? undefined : this.props.href,
	                className: (0, _classnames2.default)(_styles2.default.root, isDisabled ? _styles2.default.disabled : false, this.props.outline ? _styles2.default.outline : false, this.props.className.indexOf(_main2.default.block) != -1 ? _styles2.default.block : false, this.props.className),
	...
	Button.styles = _styles2.default;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Icon = function (_React$Component) {
	    ...
	    _createClass(Icon, [{
	        key: 'render',
	        value: function render() {
	            return React.createElement('i', { className: Icon.get(this.props.name) + ' ' + this.props.className });
	        }
	    }], [{
	        key: 'get',
...
/***/ function(module, exports) {
	...
	// removed by extract-text-webpack-plugin
	module.exports = {"root":"styles__root___21Emz"};
